...
class commander_rally_trees extends StatefulWidget {
  commander the_chosen;
  commander_rally_trees({required this.the_chosen});
  @override
  State<commander_rally_trees> createState() => _commander_rally_trees();
}

class _commander_rally_trees extends State<commander_rally_trees> {
  @override
  Widget build(BuildContext context) {
    double screen_width = MediaQuery.of(context).size.width;
    double screen_height = MediaQuery.of(context).size.height;
    int list_length = widget.the_chosen.rally_tree_paths.length;
              ...
              if (list_length > 0) {
                return Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                          '${widget.the_chosen.general_speech_about_rally_tree(context)[index]}',
                              ...
                              children: [
                                RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            '${widget.the_chosen.rally_tree_stats[index][0]}',
                                        style: TextStyle(color: Colors.black))
                                  ]),
                                ),
                                RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            '${widget.the_chosen.rally_tree_stats[index][1]}',
                                        style: TextStyle(color: Colors.black))
                                  ]),
                                ),
                                RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            '${widget.the_chosen.rally_tree_stats[index][2]}',
                                        style: TextStyle(color: Colors.black))
                                  ]),
                                ),
                                RichText(
                                  text: TextSpan(children: [
                                    ...
                                    TextSpan(
                                        text:
                                            '${widget.the_chosen.rally_tree_stats[index][3]}',
                                        style: TextStyle(color: Colors.black))
                                  ]),
                                ),
                              ],
                                  ...
                                  children: [
                                    Image(
                                      ...
                                      image: AssetImage(widget
                                          .the_chosen.rally_tree_paths[index]),
                                      fit: BoxFit.fill,
                                    ),
                                    Positioned.fill(
                                      child: Center(
