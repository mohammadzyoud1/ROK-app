...
class VIP_data extends StatefulWidget {
  void Function(String) saving;
  VIP_data({
    required this.saving,
  });
  @override
  State<VIP_data> createState() => _VIP_data();
}

class _VIP_data extends State<VIP_data> {
          ...
          Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('images/vip.jpg'), fit: BoxFit.fill))),
          Padding(
