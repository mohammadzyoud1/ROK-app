...
class Training_speed_data extends StatefulWidget {
  void Function(String) saving;
  Training_speed_data({
    required this.saving,
  });
  @override
  State<Training_speed_data> createState() => _Training_speed_data();
}

class _Training_speed_data extends State<Training_speed_data> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Training speed Data'),
      ),
      body: Stack(
        children: [
          Container(
