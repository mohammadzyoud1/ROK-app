...
class Healing_speed_data extends StatefulWidget {
  void Function(String) saving;
  Healing_speed_data({
    required this.saving,
  });
  @override
  State<Healing_speed_data> createState() => _Healing_speed_data();
}

class _Healing_speed_data extends State<Healing_speed_data> {
