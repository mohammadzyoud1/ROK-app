...
class Universal_speed_data extends StatefulWidget {
  void Function(String) saving;
  Universal_speed_data({
    required this.saving,
  });
  @override
  State<Universal_speed_data> createState() => _Universal_speed_data();
}

class _Universal_speed_data extends State<Universal_speed_data> {
  ...
  final TextEditingController value_control_1440 = TextEditingController();
  final TextEditingController value_control_4320 = TextEditingController();
  final TextEditingController value_control_10080 = TextEditingController();
  final TextEditingController value_control_43200 = TextEditingController();
  void reset() {
    ...
    value_control_1440.text = '0';
    value_control_4320.text = '0';
    value_control_10080.text = '0';
    value_control_43200.text = '0';
    total = 0;
    shownvalue = '0';
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Universal speed Data'),
      ),
      body: Stack(
        children: [
          Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    padding_method('24h', value_control_1440),
                    padding_method('3d', value_control_4320),
                    padding_method('7d', value_control_10080),
                    padding_method('30d', value_control_43200),
                    SizedBox(height: 20),
                    Row(
                      children: [
                        Expanded(
  ...
  void calculation() {
    setState(() {
      total = (int.tryParse(value_control_1.text) ?? 0) * 1 +
          ...
          (int.tryParse(value_control_1440.text) ?? 0) * 1440 +
          (int.tryParse(value_control_4320.text) ?? 0) * 4320 +
          (int.tryParse(value_control_10080.text) ?? 0) * 10080 +
          (int.tryParse(value_control_43200.text) ?? 0) * 43200;
    });
