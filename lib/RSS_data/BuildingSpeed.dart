...
class Building_speed_data extends StatefulWidget {
  void Function(String) saving;
  Building_speed_data({
    required this.saving,
  });
  @override
  State<Building_speed_data> createState() => _Building_speed_data();
}

class _Building_speed_data extends State<Building_speed_data> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Building speed Data'),
      ),
      body: Stack(
        children: [
          Container(
